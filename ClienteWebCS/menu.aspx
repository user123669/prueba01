        ...
        <article>
          <header class="section background-white">
            <div class="line text-center">        
              <h1 class="text-dark text-s-size-30 text-m-size-40 text-l-size-headline text-thin text-line-height-1">AQUI ENCUENTRE TODO LO QUE NECESITA</h1>
              <p class="margin-bottom-0 text-size-16 text-dark">EL GRAN SABER<br>
            </div>  
          </header>
      ...
      <footer>
          ...
          <div class="line">
            <div class="margin">
              ...
              <div class="s-12 m-12 l-4 margin-m-bottom-30">
                <h3 class="text-size-16">INFORME DE EMPRESA</h3>
        ...
        <section class="padding background-dark full-width">
          <div class="text-center">
            <p class="text-size-12">LOS RENACIDOS</p>
          </div>
        </section>
      </footer>
    </div>
